...
urlpatterns = [
    ...
    url(r'^category/(?P<pk>\d+)/$', CategoryPackageDetailView.as_view(), name='category-detail-view'),
    url(r'^book/$', BookPackageView.as_view(), name='book-view'),
    url(r'^book/(?P<pk>\d+)/$', BookPackageDetailView.as_view(), name='book-detail-view'),
